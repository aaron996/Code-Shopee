...
,case when (sls.pku_done_time is null and o.seller_shipping_address_state = 'Nghệ An' and o.logistics_status_id <> 4) then 'Pending pickup'
else 'Pending Deli'
end as "Check pending"
...
where 
o.logistics_status_id not in (7,8,10,11)
and o.fulfilment_channel_id in (50015,50016)
and ((
    sls.pku_done_time is null 
    and o.seller_shipping_address_state = 'Quảng Nam'
    and o.seller_shipping_address_city = 'Thành Phố Hội An' 
    and o.logistics_status_id <> 4)
or (
    o.logistics_status_id = 2 
    and o.buyer_shipping_address_state = 'Quảng Nam'
    and o.buyer_shipping_address_city = 'Thành Phố Hội An'
    ))
